...
function carregarFuncionariosFiltrado(cargo) {
  const funcionariosFiltrados = funcionarios.filter(funcionario => funcionario.cargo.toLowerCase() === cargo.toLowerCase());
  showFuncionarios(funcionariosFiltrados);
}

function showFuncionarios(listaFuncionarios) {
